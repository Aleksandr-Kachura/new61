 ...
 *  
 */
package de.hybris.electronics.core.hmc;
...
/**
 * Provides necessary meta information about the electronicscore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class ElectronicsCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ElectronicsCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.electronics.core.hmc.locales";
