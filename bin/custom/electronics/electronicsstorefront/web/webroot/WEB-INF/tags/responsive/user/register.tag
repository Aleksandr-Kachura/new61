...
<c:if test="${empty familyUpdateProfileForm}">
<div class="headline">
...
<form:form method="post" commandName="familyRegisterForm" action="${action}">
	...
	<formElement:formInputBox idKey="register.email"
		...
		mandatory="true" />
	<div class="hidden">
		<formElement:formInputBox idKey="register.familyName"
								  labelKey="register.familyName" path="familyName" inputCSS="form-control"
								  mandatory="true" />
	</div>
