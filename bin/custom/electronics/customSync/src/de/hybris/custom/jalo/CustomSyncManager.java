...
import de.hybris.custom.constants.CustomSyncConstants;



/**
 * This is the extension manager of the CustomSync extension.
 */
public class CustomSyncManager extends GeneratedCustomSyncManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CustomSyncManager.class.getName());
	 ...
	 */
	public static CustomSyncManager getInstance()
	{
		return (CustomSyncManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CustomSyncConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomSyncManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CustomSyncManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CustomSyncManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CustomSyncManager called, current tenant: " + getTenant().getTenantID());
		}
	}
